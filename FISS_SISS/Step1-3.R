...
# p_correct_commonc <- aggregate(e1sa01 + e1sa04 + e1sa05 + e1sa06 + 
#             e1sa07 + e1sa08   +   e1sa12   + e1sa14 + e1sa15+
#             e1sa16 + e1sa17 + e1sa18+
#             e1sb02 + e1sb03 + e1sb04+
#             e1sb06 + e1sb07 + e1sb08 + e1sb09 + e1sb10+
#             e1sb18 + e1sb19 + e1sb20 ~ new_cnt + TestTime, data = all, mean)

# colnames(p_correct_commonc) <- c("country","time","p_cr")


# item1 <- item1[item1$new_cnt %in% c("FINLAND",
#                                                    "HUNGARY",
#                                                    "ITALY",
#                                                    "JAPAN",
#                                                    "SWEDEN",
...
#nam <- noquote(colnames(all[,21:45]))

# itemlist <- list()
# for (i in 1:22) {
#    itemlist[[i]] <- aggregate(e1sa01 ~ new_cnt + TestTime, data = all[c(20+1,43:45)], mean)
# 
# }
# 
# for (i in 1:22) {
